...
public class SortedList extends javax.swing.JFrame
{
    StringBuilder sb;
    File f;
    public SortedList()
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(SortedList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new SortedList().setVisible(true);
            }
        });
    }
